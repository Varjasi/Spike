...
#daru.control.limits(acceleration=3000)

#daru.run_angle(1000,150,Stop.NONE,wait=False)
...
MenjPonthoz(780+30,972+3) # szürke szemetes fölé megyünk

wait(4000)

#MenjPonthoz(924,880, Előre=False) # kicsit visszatolattunk

#DaruKalibráció()

#DaruBeállít(76)

#MenjPonthoz(X-80,Y+70) # szürke szemét fölé álltunk
