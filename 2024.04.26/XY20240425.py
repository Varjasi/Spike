...
IndulásiPozícióHidas = IndulásiPozíció(791,153,-90) # X, Y, szög
IndulásiPozícióAkadályos = IndulásiPozíció(200, 400, 90) # !!!
...
def MenjFalnak():
    ...
    if alfa<pi/2: # bal oldali palánknak ütköztünk
